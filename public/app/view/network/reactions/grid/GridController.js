...
Ext.define('NU.view.network.reactions.grid.GridController', {
	...
	init: function () {
		...
		this.mon(NU.Network, 'message.support.nusight.ReactionHandles', this.onReactionHandles, this);
	},
	...
	onCheckChange: function (column, rowIndex, checked) {
		...
		var reactionHandles = new API.message.support.nusight.ReactionHandles();
