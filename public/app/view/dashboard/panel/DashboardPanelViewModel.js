...
Ext.define('NU.view.dashboard.panel.DashboardPanelViewModel', {
	...
	formulas: {
		...
		state: function (get) {
			return NU.TypeMap.get(API.message.behaviour.proto.Behaviour.State)[get('behaviourState')] || this.getUninitialised();
		},
		mode: function (get) {
			return NU.TypeMap.get(API.message.input.proto.GameState.Data.Mode)[get('gameMode')] || this.getUninitialised();
		},
		phase: function (get) {
			return NU.TypeMap.get(API.message.input.proto.GameState.Data.Phase)[get('gamePhase')] || this.getUninitialised();
		},
		walk: function (get) {
		...
		penalty: function (get) {
			return NU.TypeMap.get(API.message.input.proto.GameState.Data.PenaltyReason)[get('penaltyReason')] || this.getUninitialised();
		},
		penaltyBackground: function (get) {
			...
			return this.getColor(penaltyReason === API.message.input.proto.GameState.Data.PenaltyReason.UNPENALISED);
		},
