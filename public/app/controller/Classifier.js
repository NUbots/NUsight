Ext.define('NU.controller.Classifier', {
    ...
    onRawImageClick: function (e, rawCanvas) {
        ...
        var ycc = this.getYCCfromRGB(rgba[0], rgba[1], rgba[2]);
        ...
        this.addLookupColour(ycc, type);
        this.classifiedUpdate();
    },
    addLookupColour: function (ycc, type) {
    ...
    classifiedUpdate: function (cimage, col, x, y) { // (classified image, colour)
        ...
        var rawCtx = this.getRawContext();
        var rawData = rawCtx.getImageData(0, 0, 320, 240);
        ...
        for (var row = 0; row < 240; row++) {
            for (var col = 0; col < 320; col++) {
                ...
                var ycc = this.getYCCfromRGB(rawData.data[index], rawData.data[index + 1], rawData.data[index + 2]);
                var hash = this.hash(ycc);
        ...
        classifiedCtx.putImageData(classifiedData, 0, 0);
    },
