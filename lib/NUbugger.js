...
function NUbugger (io) {
	...
	self.addRobot('10.0.1.41', 'Robot #1');
	self.addRobot('10.0.1.42', 'Robot #2');
	self.addRobot('10.0.1.43', 'Robot #3');
	self.addRobot('10.0.1.44', 'Robot #4');
	self.addRobot('10.0.1.45', 'Robot #5');
	self.addRobot('10.0.1.46', 'Robot #6');
	self.addRobot('10.0.1.47', 'Robot #7');
