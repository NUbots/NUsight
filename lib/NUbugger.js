...
function NUbugger (io) {
	...
	self.addRobot('10.1.1.1', 'Robot #1');
	self.addRobot('10.1.2.1', 'Robot #1e');
	self.addRobot('10.1.1.2', 'Robot #2');
	self.addRobot('10.1.2.2', 'Robot #2e');
	self.addRobot('10.1.1.3', 'Robot #3');
	self.addRobot('10.1.2.3', 'Robot #3e');
	self.addRobot('10.1.1.4', 'Robot #4');
	self.addRobot('10.1.2.4', 'Robot #4e');
	self.addRobot('10.1.1.5', 'Robot #5');
	self.addRobot('10.1.2.5', 'Robot #5e');
